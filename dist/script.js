...
var tabs = function tabs(headerSelector, tabsSelector, contentsSelector, classActive) {
  var header = document.querySelector(headerSelector);
  var tabs = document.querySelectorAll(tabsSelector);
  var content = document.querySelectorAll(contentsSelector);
  ...
  header.addEventListener("click", function (e) {
    var target = e.target; // Проверяем имеент ли таргет клаасс tabsSelector и replace удаляем точку в названии классса т.к. classList уже знает что это будет класс
